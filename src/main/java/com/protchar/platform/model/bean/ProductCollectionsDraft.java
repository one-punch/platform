 ...
 */
@Entity
@Table(name = "product_collections_draft", schema = "platform", catalog = "")
@IdClass(ProductCollectionsDraftPK.class)
public class ProductCollectionsDraft {
    ...
    public boolean equals(Object o) {
        ...
        ProductCollectionsDraft that = (ProductCollectionsDraft) o;
